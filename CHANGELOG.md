...
## [v11.11.0] - 2022-12-06
### Added
- `node_pool_location_policy` variable

## [v11.10.0] - 2022-12-05
### Fixed
- Missing GKE master part for network policy enablement

## [v11.9.1] - 2022-10-12
### Fixed
- support for GKE Prometheus monitoring
...
## [v11.8.0] - 2022-09-06
### Added
- Ignore `initial_node_count` parameter - allows manual changes to node count on node pools

## [v11.7.0] - 2022-08-29
### Added
 - `image_streaming` variable.
